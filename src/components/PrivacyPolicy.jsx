...
const PrivacyPolicy = () => {
  ...
  <title>Privacy Policy | Your Information Security Matters to Us - Gold Sparrow Global</title>
      ...
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> When visitors leave
      ...
      <p className="text-[#555] text-2xl font-bold">Media</p>
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> If you upload images
      ...
      <p className="text-[#555] text-2xl font-bold">Cookies</p>
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> If you leave a
      ...
      <p className="text-[#555] text-2xl font-bold">
        Embedded content from other websites
      </p>
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> Articles on this site
        may include embedded content (e.g. videos, images, articles, etc.).
      ...
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> If you request a
      ...
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> If you leave a
        comment, the comment and its metadata are retained indefinitely. This is
      ...
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> If you have an
        account on this site, or have left comments, you can request to receive
      ...
      <p className="text-[#555] text-2xl font-bold">Where your data is sent</p>
      <p className="text-base text-[#777]">
        <span className="font-bold">Suggested text:</span> Visitor comments may
